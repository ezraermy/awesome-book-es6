...
**[Awesome Books]** Aimed at creating a list of books using javascrpt ES6 that can be modified by user requirement. The goal is to make it more organized by using modules.
